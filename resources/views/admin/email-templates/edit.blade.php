...
<div class="btn-group" role="group">
    ...
    <a href="{{ route('admin.email-templates.show', $template) }}" class="btn btn-outline-primary">
        ...
        <div class="card">
            <div class="card-header bg-white border-0">
                <h5 class="card-title mb-0">
                    <i class="bi bi-pencil-square me-2 text-primary"></i>Edit Email Template
                </h5>
                <p class="text-muted small mb-0">Modify the email template details and content</p>
            </div>
            ...
            <div class="card-body">
                <form action="{{ route('admin.email-templates.update', $template) }}" method="POST" id="templateForm">
                    ...
                    <div class="mb-4">
                        <div class="alert alert-secondary">
                            <h6 class="alert-heading">
                                <i class="bi bi-braces me-2"></i>Detected Variables
                            </h6>
                            <p class="mb-2">These variables are currently used in your template:</p>
                            <div class="d-flex flex-wrap gap-2">
                                @foreach($template->variables as $variable)
                                    <code class="badge bg-white text-secondary">{{$variable}}</code>
                                @endforeach
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card-body">
                            <div class="row text-muted small">
                                <div class="col-md-6">
                                    ...
                                    Created: {{ $template->created_at->format('M d, Y \a\t g:i A') }}
                                </div>
                                <div class="col-md-6">
                                    <i class="bi bi-clock me-1"></i>
                                    Last Updated: {{ $template->updated_at->format('M d, Y \a\t g:i A') }}
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <div>
                            <button type="button" class="btn btn-outline-success me-2" onclick="duplicateTemplate()">
...
<!-- Duplicate Form -->
<form id="duplicateForm" action="{{ route('admin.email-templates.duplicate', $template) }}" method="POST" style="display: none;">
    @csrf
</form>
